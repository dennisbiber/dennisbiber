...
Software and AI engineer building **local-first AI** — on-premise agents and computer-vision systems that businesses own outright, with no cloud dependency or subscription lock-in.

A decade across autonomous vehicles (Uber ATG), AR/VR research (Meta Reality Labs), and defense robotics (DARPA / Carnegie Robotics), now independent and focused on making capable AI run on hardware you control instead of renting it by the month.

## What I work on

- **On-prem LLM agents** — function-calling systems that run locally, no SaaS dependency
- **Computer vision for physical spaces** — real-time perception for interactive, real-world environments
